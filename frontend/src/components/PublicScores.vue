            ...
            <div class="mt-2 md:ml-4 overflow-x-auto md:overflow-visible flex-shrink-0">
              <div class="flex space-x-2">
                <span v-for="(s, idx) in team.scores" :key="idx"
                      :class="['px-3 py-1 inline-flex items-center justify-center rounded-full text-sm font-semibold whitespace-nowrap leading-6', s.highlight ? 'text-white' : 'text-gray-800' ]"
