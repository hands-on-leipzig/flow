...
Generated: 2025-12-01 11:55:12
Database: fll_planning_prod
Environment: prod
...
| `date` | `date` | NO | - | NULL | - |
| `days` | `tinyint(4) unsigned` | NO | - | NULL | - |
| `link` | `varchar(255)` | YES | - | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `event_season_foreign` | season | NO | BTREE |
...
| `room` | `room` | `room`.`id` | NO ACTION | SET NULL |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `news_user_news_id_foreign` | news_id | NO | BTREE |

### Foreign Keys

| Constraint | Column | References | On Update | On Delete |
|------------|--------|------------|-----------|----------|
| `news_user_news_id_foreign` | `news_id` | `m_news`.`id` | RESTRICT | CASCADE |
| `news_user_user_id_foreign` | `user_id` | `user`.`id` | RESTRICT | CASCADE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `publication_event_foreign` | event | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `idx_event_access_date` | event, access_date | NO | BTREE |
...
| `plan` | `int(10) unsigned` | NO | MUL | NULL | - |
| `team_number_plan` | `int(10)` | NO | - | NULL | - |
| `room` | `int(10) unsigned` | YES | - | NULL | - |
...
| Constraint | Column | References | On Update | On Delete |
|------------|--------|------------|-----------|----------|
| `team_plan_ibfk_3` | `room` | `room`.`id` | SET NULL | SET NULL |
| `team_plan_ibfk_4` | `room` | `room`.`id` | SET NULL | SET NULL |
