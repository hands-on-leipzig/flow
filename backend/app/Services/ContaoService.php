...
class ContaoService
{
     ...
     */
    public function getScoresForRound(string $round, int $tournamentId, array &$results): void
    {
    ...
    private function roundToCode($round): string
    {
        return match ($round) {
            'vr1' => 'r_round_1',
            'vr2' => 'r_round_2',
    ...
    public function writeMatchupsToSchedule($round, $tournamentId, $eventId): array
    {
