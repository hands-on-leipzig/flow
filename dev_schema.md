...
| `first_program` | `int(10) unsigned` | YES | MUL | NULL | - |
...
|------------|---------|--------|------|
| `m_activity_type_first_program_index` | first_program | NO | BTREE |
...
| `activity_type` | `int(10) unsigned` | NO | MUL | NULL | - |

### Indexes

| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_activity_type_detail_activity_type_index` | activity_type | NO | BTREE |
| `m_activity_type_detail_first_program_index` | first_program | NO | BTREE |
...
| `code` | `varchar(50)` | YES | - | NULL | - |
| `first_program` | `int(10) unsigned` | YES | MUL | NULL | - |
| `level` | `int(10) unsigned` | YES | MUL | NULL | - |
| `sequence` | `smallint(5) unsigned` | NO | - | 0 | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_insert_point_first_program_index` | first_program | NO | BTREE |
| `m_insert_point_level_index` | level | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_parameter_first_program_index` | first_program | NO | BTREE |
| `m_parameter_level_index` | level | NO | BTREE |
...
|--------|------|------|-----|---------|-------|
| `id` | `int(10) unsigned` | NO | PRI | NULL | - |
| `parameter` | `int(10) unsigned` | YES | MUL | NULL | - |
| `if_parameter` | `int(10) unsigned` | YES | MUL | NULL | - |
| `is` | `enum('=','<','>')` | YES | - | NULL | - |
| `value` | `varchar(255)` | YES | - | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_parameter_condition_parameter_foreign` | parameter | NO | BTREE |
| `m_parameter_condition_if_parameter_foreign` | if_parameter | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_role_first_program_index` | first_program | NO | BTREE |
...
| `name` | `varchar(255)` | YES | - | NULL | - |
| `sequence` | `smallint(5) unsigned` | NO | - | 0 | - |
| `room_type_group` | `int(10) unsigned` | NO | MUL | NULL | - |
| `level` | `int(10) unsigned` | NO | MUL | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_room_type_level_index` | level | NO | BTREE |
| `m_room_type_room_type_group_index` | room_type_group | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_supported_plan_first_program_index` | first_program | NO | BTREE |
...
|--------|------|------|-----|---------|-------|
| `id` | `int(10) unsigned` | NO | PRI | NULL | - |
| `activity_type_detail` | `int(10) unsigned` | YES | MUL | NULL | - |
| `role` | `int(10) unsigned` | YES | MUL | NULL | - |

### Indexes

| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `m_visibility_activity_type_detail_foreign` | activity_type_detail | NO | BTREE |
| `m_visibility_role_foreign` | role | NO | BTREE |
...
| `activity_group` | `int(10) unsigned` | NO | MUL | NULL | - |
| `start` | `datetime` | NO | - | NULL | - |
| `end` | `datetime` | NO | - | NULL | - |
| `room_type` | `int(10) unsigned` | YES | MUL | NULL | - |
...
| `activity_type_detail` | `int(10) unsigned` | NO | MUL | NULL | - |
| `extra_block` | `int(10) unsigned` | YES | MUL | NULL | - |

### Indexes

| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `activity_activity_group_foreign` | activity_group | NO | BTREE |
| `activity_activity_type_detail_foreign` | activity_type_detail | NO | BTREE |
| `activity_room_type_foreign` | room_type | NO | BTREE |
| `activity_extra_block_foreign` | extra_block | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `activity_group_activity_type_detail_foreign` | activity_type_detail | NO | BTREE |
| `activity_group_plan_foreign` | plan | NO | BTREE |
...
| `regional_partner` | `int(10) unsigned` | NO | MUL | NULL | - |
| `level` | `int(10) unsigned` | NO | MUL | NULL | - |
| `season` | `int(10) unsigned` | NO | MUL | NULL | - |
| `date` | `date` | NO | - | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `event_regional_partner_foreign` | regional_partner | NO | BTREE |
| `event_level_index` | level | NO | BTREE |
| `event_season_index` | season | NO | BTREE |
...
| `logo` | `int(10) unsigned` | NO | MUL | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `event_logo_event_foreign` | event | NO | BTREE |
| `event_logo_logo_foreign` | logo | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `extra_block_insert_point_foreign` | insert_point | NO | BTREE |
| `extra_block_plan_foreign` | plan | NO | BTREE |
| `extra_block_room_foreign` | room | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `logo_regional_partner_foreign` | regional_partner | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `match_plan_foreign` | plan | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `news_user_user_id_index` | user_id | NO | BTREE |
| `news_user_news_id_index` | news_id | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `plan_event_foreign` | event | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `plan_parameter_unique` | plan, parameter | YES | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `publication_event_index` | event | NO | BTREE |
...
| `id` | `int(10) unsigned` | NO | PRI | NULL | auto_increment |
| `plan` | `int(10) unsigned` | NO | MUL | NULL | - |
| `q_run` | `int(10) unsigned` | YES | MUL | NULL | - |
| `name` | `varchar(100)` | NO | - | NULL | - |
| `last_change` | `timestamp` | YES | - | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `q_plan_plan_foreign` | plan | NO | BTREE |
| `q_plan_q_run_foreign` | q_run | NO | BTREE |
...
|--------|------|------|-----|---------|-------|
| `id` | `int(10) unsigned` | NO | PRI | NULL | auto_increment |
| `q_plan` | `int(10) unsigned` | NO | MUL | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `q_plan_team_q_plan_foreign` | q_plan | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `room_event_foreign` | event | NO | BTREE |
...
| `s_one_link_access_event_foreign` | event | NO | BTREE |
...
| `order` | `int(11)` | NO | - | 0 | - |
| `slideshow_id` | `int(10) unsigned` | NO | MUL | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `slide_slideshow_id_foreign` | slideshow_id | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `slideshow_event_foreign` | event | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `table_event_event_foreign` | event | NO | BTREE |
...
|--------|------|------|-----|---------|-------|
| `id` | `int(10) unsigned` | NO | PRI | NULL | auto_increment |
| `first_program` | `int(10) unsigned` | NO | MUL | NULL | - |
| `name` | `varchar(100)` | NO | - | NULL | - |
| `event` | `int(10) unsigned` | NO | MUL | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `team_event_foreign` | event | NO | BTREE |
| `team_first_program_foreign` | first_program | NO | BTREE |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `team_plan_room_foreign` | room | NO | BTREE |
| `team_plan_plan_foreign` | plan | NO | BTREE |
| `team_plan_team_foreign` | team | NO | BTREE |
...
| `selection_regional_partner` | `int(10) unsigned` | YES | MUL | NULL | - |
| `selection_event` | `int(10) unsigned` | YES | MUL | NULL | - |

### Indexes

| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `user_selection_event_index` | selection_event | NO | BTREE |
| `user_selection_regional_partner_index` | selection_regional_partner | NO | BTREE |
...
|--------|------|------|-----|---------|-------|
| `id` | `int(10) unsigned` | NO | PRI | NULL | - |
| `user` | `int(10) unsigned` | NO | MUL | NULL | - |
| `regional_partner` | `int(10) unsigned` | NO | MUL | NULL | - |
...
| Index Name | Columns | Unique | Type |
|------------|---------|--------|------|
| `user_regional_partner_regional_partner_index` | regional_partner | NO | BTREE |
| `user_regional_partner_user_index` | user | NO | BTREE |
