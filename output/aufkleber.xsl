...
<xsl:variable name="dina4-margin-left">17.5mm</xsl:variable>
<xsl:variable name="dina4-margin-right">17.5mm</xsl:variable>
<xsl:variable name="dina4-margin-top">13.5mm</xsl:variable>
<xsl:variable name="dina4-margin-bottom">13.5mm</xsl:variable>
...
<!-- simple page master -->
            <fo:simple-page-master master-name="fsp-erste-seite"
                ...
                <fo:region-body margin-top="{$kopfbereich-erste-seite-extent} + {$body-erste-seite-margin-top}" margin-bottom="{$fussbereich-erste-seite-extent} + {$body-erste-seite-margin-bottom}" column-count="2" column-gap="15mm"/>
            ...
            <fo:simple-page-master master-name="fsp-mittlere-seite"
                ...
                margin-top="{$dina4-margin-top}"
                margin-bottom="{$dina4-margin-bottom}">
                <fo:region-body margin-top="{$kopfbereich-mittlere-seite-extent} + {$body-mittlere-seite-margin-top}" margin-bottom="{$fussbereich-mittlere-seite-extent} + {$body-mittlere-seite-margin-bottom}" column-count="2" column-gap="15mm"/>
            ...
            <fo:simple-page-master master-name="fsp-letzte-seite"
                ...
                margin-top="{$dina4-margin-top}"
                margin-bottom="{$dina4-margin-bottom}">
                <fo:region-body margin-top="{$kopfbereich-letzte-seite-extent} + {$body-letzte-seite-margin-top}" margin-bottom="{$fussbereich-letzte-seite-extent} + {$body-letzte-seite-margin-bottom}" column-count="2" column-gap="15mm"/>
            ...
            <fo:simple-page-master master-name="fsp-eine-seite"
                ...
                margin-top="{$dina4-margin-top}"
                margin-bottom="{$dina4-margin-bottom}">
                <fo:region-body margin-top="{$kopfbereich-eine-seite-extent} + {$body-eine-seite-margin-top}" margin-bottom="{$fussbereich-eine-seite-extent} + {$body-eine-seite-margin-bottom}" column-count="2" column-gap="15mm"/>
...
<!-- page sequence -->
        <fo:page-sequence master-reference="fsp">
            ...
            <fo:flow flow-name="xsl-region-body">
                ...
                <xsl:call-template name="offset" >
                    <xsl:with-param name="offset" select="@offset"/> <!-- Attribut an volunteers oder teams -->
                </xsl:call-template>
    ...
    <xsl:template name="etikett">
        <fo:block-container height="50mm" width="80mm" space-after="5mm">
            <!-- Version mit leichten grauen Rändern zum Testen vorab -->
            <!--
            <fo:block-container height="49.8mm" width="79.8mm" space-after="5mm" border="0.1mm solid #CCCCCC">
            -->
            <fo:block-container position="absolute" top="5mm" left="2mm" width="76mm"> <!-- 2mm Rand links und rechts -->
                <xsl:choose>
                    <xsl:when test="$typ='teams'">
                        <!-- TEAMS -->
                        <fo:block font-size="8mm" font-weight="bold" text-align="center">
                            <xsl:choose>
                                <xsl:when test="nachname=''">
                        ...
                        <fo:block font-size="5mm" space-before="1mm" text-align="center">
                ...
                <xsl:when test="$typ='teams'">
                    <xsl:choose>
                        <xsl:when test="../../programm='Challenge'">
                            <fo:block-container position="absolute" top="35mm" left="5mm" width="20mm" height="20mm">
                                <fo:block text-align="center"><fo:external-graphic src="{$grafx_path}/aufkleber/FLL-Challenge_stacked.png" content-width="20mm" vertical-align="middle"/></fo:block>
                            </fo:block-container>
                        </xsl:when>
                        <xsl:when test="../../programm='Explore'">
                            <fo:block-container position="absolute" top="35mm" left="5mm" width="20mm" height="20mm">
                                <fo:block text-align="center"><fo:external-graphic src="{$grafx_path}/aufkleber/FLL-Explore_stacked.png" content-width="20mm" vertical-align="middle"/></fo:block>
                            </fo:block-container>
                        </xsl:when>
                        <xsl:otherwise>
                            <fo:block-container position="absolute" top="38mm" left="5mm" width="20mm" height="20mm">
                                <fo:block text-align="left"><fo:external-graphic src="{$grafx_path}/aufkleber/FIRSTLego_iconHorz_RGB.png" content-width="20mm" vertical-align="middle"/></fo:block>
                            </fo:block-container>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:when>
            ...
            <xsl:choose>
                <xsl:when test="$rp_logo = 'ja'">
                    <fo:block-container position="absolute" top="34mm" left="30mm" width="20mm" height="20mm">
                        <fo:block text-align="center"><fo:external-graphic src="{$grafx_path}/aufkleber/submerged.png" content-width="13mm" vertical-align="middle"/></fo:block>
                    </fo:block-container>
                    <fo:block-container position="absolute" top="34mm" left="55mm" width="20mm" height="20mm">
                        <fo:block text-align="right"><fo:external-graphic src="{$grafx_path}/aufkleber/hdw.png" content-width="20mm" vertical-align="middle"/></fo:block>
                    </fo:block-container>
                </xsl:when>
                <xsl:otherwise>
                    <fo:block-container position="absolute" top="34mm" left="55mm" width="20mm" height="20mm">
